function data = DEMUSEtool_reader_Moritani_VL_5x13_8mm_SD(filepath,filename,epoch_length)
...
SIG = fread(h, [128 fsamp*epoch_length], 'short');
fclose(h);
