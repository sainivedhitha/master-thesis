function data = DEMUSEtool_reader_DAVID(filepath,filename,epoch_length)
...
for k1=21:40,
    data.SIG{k1-20,2} = EMG(k1,:)';
end
for k1=41:60,
    data.SIG{k1-40,3} = EMG(k1,:)';
end
for k1=61:80,
    data.SIG{k1-60,4} =EMG(k1,:)';
end
for k1=81:100,
    data.SIG{k1-80,5} = EMG(k1,:)';
end
for k1=101:120,
    data.SIG{k1-100,6} = EMG(k1,:)';
end
for k1=121:126,
    data.SIG{k1-120,7} = EMG(k1,:)';
end
