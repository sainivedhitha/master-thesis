function data = DEMUSEtool_reader_SpesMedica_5x13_8mm_SD_permutator_64_out_of_128chs_oldXML(filepath,filename,epoch_length)
% function data = DEMUSEtool_reader_SpesMedica_5x13_8mm_SD_permutator_64_out_of_128chs_oldXML(filepath,filename,epoch_length)
%
% DEMUSEtool reader: reads surface EMG acquired by a matrix of 5x13
% electrodes with inter-electrode distance of 8 mm - old XML file, 64 
% channels out of 128 corresponding to surface EMG. 
%
% INPUTS:
...
[SIG, force] = autoLoad64_out_of_128ch(filepath,filename,1,2048);
